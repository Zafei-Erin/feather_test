...
JQ := $(shell which jq)
HTTPS_GIT := https://github.com/Zafei-Erin/feather_test.git
...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=$(FEATH_CONFIG_APP_NAME) \
		  ...
		  -X github.com/Zafei-Erin/feather_test/app.AppName=$(FEATH_CONFIG_APP_NAME) \
		  -X github.com/Zafei-Erin/feather_test/app.AccountAddressPrefix=$(FEATH_CONFIG_ACC_ADDR_PREFIX) \
		  -X github.com/Zafei-Erin/feather_test/app.AccountPubKeyPrefix=$(FEATH_CONFIG_ACC_PUBKEY_PREFIX) \
		  -X github.com/Zafei-Erin/feather_test/app.ValidatorAddressPrefix=$(FEATH_CONFIG_VALIDATOR_ADDRESS_PREFIX) \
		  -X github.com/Zafei-Erin/feather_test/app.ValidatorPubKeyPrefix=$(FEATH_CONFIG_VALIDATOR_PUBKEY_PREFIX) \
		  -X github.com/Zafei-Erin/feather_test/app.ConsensusNodeAddressPrefix=$(FEATH_CONFIG_CONS_NODE_ADDR_PREFIX) \
		  -X github.com/Zafei-Erin/feather_test/app.ConsensusNodePubKeyPrefix=$(FEATH_CONFIG_ACC_PUBKEY_PREFIX) \
		  -X github.com/Zafei-Erin/feather_test/app.BondDenom=$(FEATH_CONFIG_BOND_DENOM)
